...
const SERVER_IP = process.env.SERVER_IP || "13.202.129.139"; // Set to 3.111.87.2 for external access
...
const setupMqttClient = () => {
  const brokerUrl = process.env.MQTT_BROKER_URL || "mqtt://13.202.129.139:1883"; // Set in .env file
...
// MongoDB Connection
mongoose
  .connect(process.env.MONGO_URI || "mongodb://13.202.129.139:27017/gateway")
  .then(() => {
